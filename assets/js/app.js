            ...
            <div class="glass-card p-6 rounded-2xl border border-slate-800 hover:border-indigo-500/40 transition">
              ...
              ${act.certificateLink ? `
                <div class="pt-3 mt-3 border-t border-slate-800/80">
                  <a href="${act.certificateLink}" target="_blank" rel="noopener noreferrer" 
                     class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-xs font-semibold bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 transition">
                    <i data-lucide="award" class="w-3.5 h-3.5"></i>
                    ${state.lang === 'th' ? 'ดูเกียรติบัตรการเข้าร่วม (PDF)' : 'View Certificate of Participation (PDF)'}
                  </a>
                </div>
              ` : ''}
            </div>
